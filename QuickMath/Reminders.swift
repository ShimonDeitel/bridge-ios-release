...
enum Reminders {
    private static let identifier = "bridge.daily.reminder"
    ...
    static func schedule(hour: Int, minute: Int) {
        ...
        content.title = "Today's Bridge puzzle is ready"
        content.body = "One bridges puzzle a day. Keep your streak alive."
